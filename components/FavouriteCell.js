    ...
    <View style={styles.mainView}>
      <View style={styles.recipeImageView}>
        ...
        <TouchableOpacity>
          ...
          />
          <TouchableOpacity style={{ position: 'absolute', top: 10, right: 10, opacity: 1.0}} onPress={() => {props.onClick(props.itemList)}}>
          <AntDesign name="heart" size= {20} color='red' />  
          </TouchableOpacity>
        </TouchableOpacity>
        <Text style={{fontSize: 20, alignSelf: 'flex-start', height: 30}}>  {props.itemList.recipeName} </Text>
      </View>
    </View>
    </SafeAreaView>
  );
